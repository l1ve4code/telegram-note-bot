...
public class ShowNoteActionsCallback implements Callback {
    ...
    public void processCallback(Update update) {
        ...
        messageSenderService.editDefaultImageKeyboard(chatId, messageId, InlineKeyboardTemplates.getNoteActions());
    }

    @Override
    public CallbackType getCallbackType() {
        return CallbackType.SHOW_NOTE_ACTIONS;
    }
