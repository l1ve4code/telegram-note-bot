...
public class ShowNotificationActionsCallback implements Callback {
    ...
    public void processCallback(Update update) {
        ...
        messageSenderService.editDefaultImageKeyboard(chatId, messageId, InlineKeyboardTemplates.getNotificationActions());
    }

    @Override
    public CallbackType getCallbackType() {
        return CallbackType.SHOW_NOTIFICATION_ACTIONS;
    }
