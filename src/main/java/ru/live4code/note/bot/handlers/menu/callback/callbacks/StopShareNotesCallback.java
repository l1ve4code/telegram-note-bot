...
public class StopShareNotesCallback implements Callback, CallbackAnswer {
    ...
    public void processCallback(Update update) {
        ...
        if (myShares.isEmpty()) {
            messageSenderService.sendMessage(chatId, "You don't share notes with anyone \uD83E\uDD14");
            return;
        }
    ...
    public void processCallbackAnswer(Update update) {
        ...
        messageSenderService.sendDeleteReplyMessage(chatId, String.format("Share was successfully disabled with user: '%s' \uD83E\uDD19", message));
    }
